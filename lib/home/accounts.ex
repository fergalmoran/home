defmodule Home.Accounts do
  ...
  @doc """
  Gets a user by their OAuth provider and provider ID.
  """
  ...
  If a user with the same email exists (without OAuth), links the OAuth provider.
  """
    ...
    case get_user_by_provider(provider, provider_id) do
      ...
      nil ->
        ...
        case get_user_by_email(attrs.email) do
          ...
          %User{} = user ->
            # User already linked to a different OAuth provider
            {:ok, user}
