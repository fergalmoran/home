defmodule HomeWeb.Router do
  ...
  scope "/", HomeWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{HomeWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", HomeWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{HomeWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", HomeWeb do
    ...
    live_session :current_user,
      on_mount: [{HomeWeb.UserAuth, :mount_current_user}] do
