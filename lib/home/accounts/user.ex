defmodule Home.Accounts.User do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Home.Repo)
  ...
  """
  def valid_password?(%Home.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def oauth_changeset(user, attrs) do
    ...
    |> confirm_changeset_if_new()
  end

  defp confirm_changeset_if_new(changeset) do
  ...
  @doc """
  Returns true if the user signed up via OAuth.
  """
  def oauth_user?(%__MODULE__{provider: provider}) when not is_nil(provider), do: true
